...
import image from '../assets/bg.png'; // Make sure this matches the actual file name
  ...
  return (
    <div className="relative w-full h-screen overflow-x-hidden">
      ...
      <div className="absolute top-4 right-4 flex items-center space-x-3 z-20">
        {/* Order Now Box */}
        <div className="bg-white text-red-500 px-6 py-2 rounded-md flex items-center justify-center">
